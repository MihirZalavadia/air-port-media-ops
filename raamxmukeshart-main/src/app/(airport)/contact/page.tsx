...
export const metadata: Metadata = {
    ...
    description:
        "Start your Rajkot Airport advertising campaign — share your brand, media interest, and timeline, and the Mukesh Art team will respond within one working day.",
